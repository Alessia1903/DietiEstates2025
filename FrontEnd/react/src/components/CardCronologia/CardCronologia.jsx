  ...
  return (
    <div className="search-card-container">
      <div className="search-card-header">
        ...
        <span className={`search-card-type-badge ${(filtro.contratto || "N/A").toLowerCase()}`}>
          {filtro.contratto || "N/A"}
        </span>
      </div>
      ...
      <div className="search-card-details">
        <div className="search-card-detail-item">
          ...
          Classe {filtro.classeEnergetica}
        </div>
        <div className="search-card-detail-item">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <div className="search-card-detail-item">
          ...
          {formatPrice(filtro.prezzoMin)} - {formatPrice(filtro.prezzoMax)}
        </div>
      </div>

      <div className="search-card-footer">
        <div />
        <button className="search-card-repeat" onClick={handleCerca}>
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
